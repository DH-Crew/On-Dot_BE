...
@Tag(
        ...
        <b>🔔 Alarm 관련 ENUM</b>:<br>
        • AlarmMode: <code>SILENT</code>, <code>VIBRATE</code>, <code>SOUND</code><br>
        • SnoozeInterval: 1, 3, 5, 10, 30, 60 (분)<br>
        • SnoozeCount: -1(INFINITE), 1, 3, 5, 10 (회)<br>
        • Mission: 미정<br>
        • RingTone: 미정<br>
        • SoundCategory: 미정
        """
